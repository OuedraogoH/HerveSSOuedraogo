...
const I18N = {
  en:{
    ...
    disclaimer:"This is a personal website. The views expressed are those of Hervé Ouédraogo in his personal capacity and do not necessarily reflect the views or policies of the Food and Agriculture Organization of the United Nations or the United Nations.<br><br>The postings on this site are my own and do not necessarily represent FAO’s views, positions, strategies or opinions.",
  ...
  fr:{
    ...
    disclaimer:"Ceci est un site personnel. Les opinions exprimées sont celles de Hervé Ouédraogo, à titre personnel, et ne reflètent pas nécessairement les vues ou les politiques de l’Organisation des Nations Unies pour l’alimentation et l’agriculture ni de l’Organisation des Nations Unies.<br><br>Les publications de ce site sont les miennes et ne représentent pas nécessairement les vues, positions, stratégies ou opinions de la FAO.",
