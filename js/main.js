...
const I18N = {
  ...
  it:{
    ...
    nav_about:"Profilo", nav_moments:"Momenti", nav_focus:"Competenze", nav_journey:"Percorso",
    ...
    hero_cta1:"Consulta il CV", hero_cta2:"Mettiti in contatto",
    hero_m2:"Ufficio regionale della FAO per l’Africa", hero_m3:"bilingue, prospettiva panafricana", badge:"Funzionario regionale di programma",

    about_eyebrow:"Profilo",
    about_h2:"Un professionista plasmato dal campo, dalla regione e dal sistema.",
    about_p1:"Hervé Ouédraogo è un affermato professionista e dirigente dello sviluppo con oltre 20 anni di esperienza, di cui 14 all’interno del sistema delle Nazioni Unite. Ha operato a livello nazionale, subregionale, regionale e centrale, nonché nel settore privato, nelle istituzioni finanziarie internazionali, nel mondo accademico e nei governi.",
    about_p2:"Presso l’Organizzazione delle Nazioni Unite per l’alimentazione e l’agricoltura (FAO), guida l’elaborazione e l’attuazione di strumenti strategici — analisi comune di paese (CCA), quadri di cooperazione delle Nazioni Unite per lo sviluppo sostenibile (UNSDCF), quadri di programmazione per paese (CPF) e UN INFO — e i programmi per la regione Africa. Fornisce consulenza e supervisiona l’allocazione e la gestione di un budget di programma annuale di 50 milioni di USD, guidando un team di oltre 60 persone in diversi paesi.",
    about_quote:"I risultati non sono burocrazia: sono la promessa fatta alle persone che serviamo, mantenuta e misurata.",
    about_p3:"La sua competenza spazia dalla pianificazione strategica alla mobilitazione delle risorse e all’approccio sistemico al servizio della trasformazione dei sistemi agroalimentari, con particolare attenzione ai cambiamenti climatici, alla gestione delle risorse naturali e ai partenariati che trasformano l’ambizione in risultati.",
    glance_title:"In sintesi",
    glance_1:"anni nello sviluppo internazionale",
    glance_2:"budget di programma regionale annuale seguito",
    glance_3:"persone guidate in diversi paesi",
    ...
    cap_rabat:"Allocuzione alla 33ª Conferenza regionale della FAO per l’Africa, Rabat, 2024.",
    ...
    cap_capacity:"Scambi sullo sviluppo delle capacità e sull’azione globale.",
    cap_agritech:"Alla scoperta delle tecnologie e dell’innovazione agricola.",
    cap_office:"Al lavoro, Ufficio regionale della FAO per l’Africa, Accra.",

    focus_eyebrow:"Aree di competenza",
    focus_h2:"Dove si concentra il lavoro.",
    focus_p:"Dai quadri di risultato al finanziamento, un insieme di competenze interconnesse, costruite in due decenni.",
    ...
    f4_t:"Mobilitazione delle risorse", f4_d:"Posizionamento presso la comunità dei donatori e strutturazione di partenariati con partner finanziari e IFI.",
    f5_t:"Iniziativa Mano nella mano", f5_d:"Punto focale regionale per i paesi francofoni, a sostegno della pianificazione degli investimenti e dei finanziamenti.",
    f6_t:"Trasformazione digitale", f6_d:"Guida dell’iniziativa SCOPE e di un’attuazione basata sui dati nella programmazione per paese.",
    ...
    j1_d:"Co-guida lo sviluppo strategico e fornisce consulenza su un budget di programma annuale di 50 milioni di USD; punto focale regionale dell’Iniziativa Mano nella mano (paesi francofoni).",
    ...
    j4_t:"Funzionario professionale associato (JPO)", j4_o:"Sede della FAO, Roma",
    ...
    j5_t:"Docente di gestione dei progetti", j5_o:"Università di Ouagadougou (IGEDD)",
    ...
    j6_d:"Economista, capo squadra di valutazione e responsabile del monitoraggio presso istituzioni bilaterali, multilaterali e di ricerca.",

    impact_eyebrow:"Impatto e riconoscimenti",
    impact_h2:"La scala, misurata in risultati.",
    s1:"Budget di programma regionale annuale seguito e supervisionato.",
    s2:"Risorse mobilitate attraverso negoziati con i donatori (2015-2017).",
    s3:"Persone raggiunte da un programma sanitario di cui ha gestito la logistica e il monitoraggio e valutazione.",
    s4:"Operatori sanitari e funzionari formati nell’ambito di campagne nazionali.",
    honours_title:"Riconoscimenti selezionati",
    h1:"FAO — Miglior team dell’anno, riconoscimenti multipli (2020, 2022, 2023, 2025)",
    h2:"FAO — Dipendente dell’anno, top 100 mondiale (2020 e 2021)",
    h3:"Top 200 dei dipendenti FAO nel mondo (2019)",
    h4:"Programma FAO per giovani professionisti di alto potenziale (2011)",
    ...
    insights_p:"Uno spazio di riflessione sulla gestione dei risultati, sui sistemi agroalimentari e sulla programmazione per paese. Nuovi contenuti e interventi appariranno qui.",
    insights_cta:"Invita Hervé a intervenire",

    life_eyebrow:"Oltre il lavoro",
    life_h2:"Mantenere la prospettiva — e trasmetterla.",
    life_lede:"Il tempo trascorso in famiglia mi aiuta a mantenere il lavoro nella giusta prospettiva. Tengo a <em>far scoprire la natura ai miei figli</em> — la fauna, la terra e gli animali al cuore dei sistemi agroalimentari su cui lavoro ogni giorno.",
    cap_nature:"Osservare insieme la fauna durante una passeggiata nel bosco.",
    cap_golf:"Sul green, insieme.", cap_sunset:"Un momento di calma in riva all’oceano.",

    pubs_eyebrow:"Pubblicazioni",
    pubs_h2:"Lavori selezionati, sottoposti a revisione paritaria e applicati.",
    ...
    p3_t:"Audit tecnico del progetto agricolo PADAZ finanziato dalla Banca africana di sviluppo, Niger.", p3_s:"(2008).",
    p4_t:"Monografia dell’agricoltura e delle catene del valore in Africa occidentale: il caso del Burkina Faso.", p4_s:"CMA/AOC, Ouagadougou (2007).",
    ...
    contact_intro:"Per richieste di partenariato, interventi o consulenze, il modo più affidabile per raggiungermi è via e-mail o LinkedIn.",
    email:"Scrivi a Hervé", linkedin:"Connettiti su LinkedIn", contact_cv:"Leggi il CV completo",
    form_name:"Nome", form_email:"E-mail", form_msg:"Messaggio", form_send:"Invia messaggio",
