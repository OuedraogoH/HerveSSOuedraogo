...
const I18N = {
  en:{
    ...
    form_success:"Thank you — message received. Hervé will be in touch soon.",
    form_error:"Something went wrong. Please try again or reach out directly by email.",
  ...
  fr:{
    ...
    form_success:"Merci — message bien reçu. Hervé vous répondra prochainement.",
    form_error:"Une erreur s'est produite. Veuillez réessayer ou contacter directement par courriel.",
...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  if(contactForm){
    ...
    contactForm.addEventListener('submit', async (e)=>{
      ...
      submitBtn.querySelector('span').textContent = dict.form_sending || 'Sending…';
      ...
      try{
        ...
        if(res.ok){
          ...
          statusEl.textContent = dict.form_success || 'Thank you — message received.';
          contactForm.reset();
        } else {
        ...
        statusEl.textContent = dict.form_error || 'Something went wrong. Please try again.';
      } finally {
        submitBtn.disabled = false;
        submitBtn.querySelector('span').textContent = dict.form_send || 'Send message';
      }
    });
  }
});
